...
% Ordenamos los coeficientes en orden descendente
...
for d = 1:12
    ...
    hold on;
    plot(sinal(d,:),'k');
    xlim([0 length(sinal(d,:))-5000]);
    title('Original Sinal Der ' + der + ' VS Sinal with PCA'),
    ylabel('Potential (mV)'),
    xlabel('Time (ms)'),
    legend("PCA Sinal","Original Sinal");
